...
The total setup time from within Salesforce is about 30 minutes.  Time spent standing up the Mule app will vary based on use case but should be quick.<br/>
